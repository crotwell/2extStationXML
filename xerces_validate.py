...
ERROR: Can't find validator: %s %s
        ...
        wget http://mirror.cc.columbia.edu/pub/software/apache//xerces/j/binaries/Xerces-J-bin.2.12.0-xml-schema-1.1.tar.gz
        tar zxf Xerces-J-bin.2.12.0-xml-schema-1.1.tar.gz
        wget http://maui.gps.caltech.edu/SIStrac/raw-attachment/wiki/SIS/Code/validator.tar.gz
        tar ztf validator.tar.gz

We assume the directories validator and xerces-2_12_0-xml-schema-1.1
are in current directory for validation.
        """%(os.path.exists('xerces-2_12_0-xml-schema-1.1') , os.path.exists('validator/ValidateStationXml.class')))
